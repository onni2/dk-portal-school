...
import {
  adminDuoQueryKeys,
  useCreateAdminDuoDevice,
  useAdminDuoDeviceStatus,
...
interface AdminDuoDeviceCreateDialogProps {
  accountId: string;
  onClose: () => void;
  onCreated?: () => void;
}
...
export function AdminDuoDeviceCreateDialog({
  ...
  onClose,
  onCreated,
}: AdminDuoDeviceCreateDialogProps) {
  const qc = useQueryClient();
  const createMutation = useCreateAdminDuoDevice(accountId);
  ...
  const { data: deviceStatus } = useAdminDuoDeviceStatus(
    accountId,
  ...
  useEffect(() => {
    ...
    onCreated?.();
  }, [isActivated, qc, accountId, onCreated]);
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-(--color-text-secondary)">
                        Veldu hvernig þú vilt tengja Duo Mobile appið við
                        aðganginn.
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-6 space-y-3">
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 text-sm text-(--color-text-secondary)">
                        Notaðu QR kóða ef Duo Mobile appið er þegar uppsett í
                        símanum.
                      </div>
                    </div>
                    <ChevronRight
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 text-sm text-(--color-text-secondary)">
                        Sendum SMS í símann þinn með hlekk til að sækja Duo
                        Mobile appið og öðrum hlekk til að tengja aðganginn.
                      </div>
                    </div>
                    <ChevronRight
                      className={cn(
